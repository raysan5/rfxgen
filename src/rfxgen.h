/*******************************************************************************************
*
*   rFXGen.h v3.0 - A simple and easy to use sounds generator library (based on Tomas Petterson sfxr)
*
*   CONFIGURATION:
*
...
RLAPI Wave GenerateWave(WaveParams params);                            // Generate wave data from parameters
...
RLAPI Wave GenerateWave(WaveParams params)
{
