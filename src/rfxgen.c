...
*   LICENSE: zlib/libpng
*
*   Copyright (c) 2014-2024 raylib technologies (@raylibtech) / Ramon Santamaria (@raysan5)
*
...
static void ShowCommandLineInfo(void)
{
    ...
    printf("//                                                                              //\n");
    printf("// Copyright (c) 2014-2024 raylib technologies (@raylibtech)                    //\n");
    printf("//                                                                              //\n");
    printf("//////////////////////////////////////////////////////////////////////////////////\n\n");
...
static void PlayWaveCLI(Wave wave)
{
    ...
    printf("// more info and bugs-report: github.com/raysan5/rfxgen                         //\n");
    printf("//                                                                              //\n");
    printf("// Copyright (c) 2020-2024 raylib technologies (@raylibtech)                    //\n");
    printf("//                                                                              //\n");
    printf("//////////////////////////////////////////////////////////////////////////////////\n\n");
